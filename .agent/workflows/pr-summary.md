...
1. Write the summary to `.pr-description.md` in the **root of the repository**
   (e.g., `/path/to/breadboard/.pr-description.md`)
...
**IMPORTANT**: Never write to `packages/*/PR.md` or any other location. Always
use `.pr-description.md` at the repo root. Never include absolute file paths.
