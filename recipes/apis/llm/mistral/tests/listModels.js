...
2. npx breadboard run listModels.js --kit @google-labs/core-kit --kit @google-labs/llm-starter -i "{ \"api_inputs\": {
      \"authentication\": {
...
const metaData = {
  title: "List Models",
  description:
    "List the models from the Mistral API (Generated by OpenAPI recipe)",
  version: "0.0.3",
};
