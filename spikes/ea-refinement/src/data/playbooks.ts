...
const PLAYBOOKS: Playbook[] = [
  ...
  },
  {
    ...
    category: "Calendar & Planning",
    description:
      "Planning Sasha's birthday party — guest list, venue, " +
      "catering, decorations, and entertainment.",
    status: "running",
    statusDetail:
      "10 days out. Venue confirmed (The Lantern Rooftop). " +
      "9 of 12 guests confirmed, catering and DJ still in progress.",
    priority: "urgent",
...
function formatPlaybooksForPrompt(): string {
  ...
  lines.push(
    `The following ${PLAYBOOKS.length} playbooks are the user's active life dashboard. ` +
