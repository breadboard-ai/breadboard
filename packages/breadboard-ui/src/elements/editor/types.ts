...
export enum GRAPH_OPERATIONS {
  ...
  GRAPH_EDGE_SELECT_DISAMBIGUATION_REQUESTED = "graphedgedisambiguationselectrequested",
  GRAPH_EDGE_ADD_DISAMBIGUATION_REQUESTED = "graphedgedisambiguationaddrequested",
