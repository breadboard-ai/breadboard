  ...
  css`
    * {
    ...
    .activity-entry.node.generative-audio h1::before {
      background: transparent var(--bb-add-icon-generative-audio) center
    ...
    .activity-entry.node.generative-image h1::before {
      background: transparent var(--bb-add-icon-generative-image) center
        center / 20px 20px no-repeat;
    }
    ...
    #download-export {
      background: var(--bb-neutral-100) var(--bb-icon-download) 8px center /
        16px 16px no-repeat;
    }
