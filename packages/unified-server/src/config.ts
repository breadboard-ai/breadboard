...
export async function createClientConfig(opts: {
  ...
  return {
    ...
    GOOGLE_DRIVE_MCP_ENDPOINT: flags.GOOGLE_DRIVE_MCP_ENDPOINT,
    ...
    GOOGLE_GMAIL_MCP_ENDPOINT: flags.GOOGLE_GMAIL_MCP_ENDPOINT,
    ...
    flags: {
      ...
      enableWorkspaceMcp: flags.ENABLE_WORKSPACE_MCP,
