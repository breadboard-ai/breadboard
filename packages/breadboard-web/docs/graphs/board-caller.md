...
formatFunctionDeclarations_map4_input3[/"input <br> id='input-3'"/]:::input -- "item->boardURL" --> formatFunctionDeclarations_map4_output4{{"output <br> id='output-4'"}}:::output
end
sg_map4:::slotted -- "lamdba->lamdba" --o formatFunctionDeclarations_map4

formatFunctionDeclarations_boards[/"input <br> id='boards'"/]:::input -- "boards->list" --> formatFunctionDeclarations_map4["map <br> id='map-4'"]
end
