...
streamTransform_transformChunk["jsonata <br> id='transformChunk'"] -- "result->chunk" --> streamTransform_output4{{"output <br> id='output-4'"}}:::output
streamTransform_input3[/"input <br> id='input-3'"/]:::input -- "chunk->json" --> streamTransform_transformChunk["jsonata <br> id='transformChunk'"]
end
