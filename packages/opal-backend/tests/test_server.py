...
from opal_backend.fake import main as server_module
from opal_backend.fake.main import app
from opal_backend.local.pending_requests import PendingRequestMap
from opal_backend.fake.scenarios import (
    chat_scenario,
    consent_scenario,
    echo_scenario,
    graph_edit_scenario,
)
from opal_backend.local.sse_sink import SSEAgentEventSink
