...
import simpleBoard from "../../../../tests/boards/simple.bgl.json" with { type: "json" };
import multipleInputsBoard from "../../../../tests/boards/many-inputs.bgl.json" with { type: "json" };
import manyOutputsBoard from "../../../../tests/boards/many-outputs.bgl.json" with { type: "json" };
import invokeWithBubblingInput from "../../../../tests/boards/invoke-board-with-bubbling-input.bgl.json" with { type: "json" };
