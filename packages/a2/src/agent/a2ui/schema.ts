...
/**
 * The complete A2UI schema. Keep in sync with
 * https://github.com/google/A2UI/blob/main/specification/json/server_to_client.json
 */
...
export const clientSchema = {
  ...
  properties: {
    ...
    clientUiCapabilities: {
      type: "object",
      description:
        "Informs the server about the client's capabilities, such as the component catalog it supports. Exactly ONE of the properties in this object must be set.",
      properties: {
        catalogUri: {
          type: "string",
          format: "uri",
          description:
            "A URI pointing to a predefined component catalog schema that the server advertized, and the client supports.",
        },
        dynamicCatalog: {
          type: "object",
          description:
            "An inline JSON object that defines the client's supported components.",
          properties: {
            components: {
              type: "object",
              description:
                "A map where each key is a component name and the value is a JSON Schema defining an object containing its properties.",
      ...
      oneOf: [{ required: ["catalogUri"] }, { required: ["dynamicCatalog"] }],
    },
    error: {
      type: "object",
