...
const MODES: Mode[] = [
  {
    id: "Manual layout",
    renderType: MANUAL_TYPE,
    title: MANUAL_MODE,
    description: "Content is displayed exactly as typed",
  },
  {
    id: "Auto",
    renderType: AUTO_TYPE,
    title: "Webpage with auto-layout",
    description: "Layout automatically generated by selected model",
  },
  {
    id: FLASH_MODE,
    renderType: AUTO_TYPE,
    title: "Auto layout with 2.5 Flash [Deprecated]",
    description: "Layout automatically generated by selected model",
  },
  {
    id: PRO_MODE,
    renderType: INTERACTIVE_TYPE,
    title: "Auto layout with 2.5 Pro [Deprecated]",
    description: "Layout automatically generated by selected model",
  },
];
