...
suite("FlowgenInputController", () => {
  ...
  test("Basics", async () => {
    const controller = new FlowgenInputController("FlowgenInput_1");
  ...
  test("Set and get input value", async () => {
    const controller = new FlowgenInputController("FlowgenInput_2");
    await controller.isHydrated;
  ...
  test("Set and get state - generating", async () => {
    const controller = new FlowgenInputController("FlowgenInput_3");
    await controller.isHydrated;
  ...
  test("Set and get state - error", async () => {
    const controller = new FlowgenInputController("FlowgenInput_4");
    await controller.isHydrated;
  ...
  test("Clear resets value and state", async () => {
    const controller = new FlowgenInputController("FlowgenInput_5");
    await controller.isHydrated;
  ...
  test("Multiple state transitions", async () => {
    const controller = new FlowgenInputController("FlowgenInput_6");
    await controller.isHydrated;
