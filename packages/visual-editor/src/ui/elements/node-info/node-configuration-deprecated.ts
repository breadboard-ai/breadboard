...
const STORAGE_PREFIX = "bb-node-configuration-deprecated";

@customElement("bb-node-configuration-deprecated")
export class NodeConfigurationInfoDeprecated extends LitElement {
  @property()
