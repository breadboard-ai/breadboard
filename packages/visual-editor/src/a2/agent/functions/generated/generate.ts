 ...
 *
 * AUTO-GENERATED from opal-backend/declarations/generate.*
...
export type GenerateSpeechFromTextParams = {
  text: string;
...
export type GenerateMusicFromTextParams = {
  prompt: string;
  file_name?: string;
  task_id?: string;
  status_update: string;
...
export type GenerateMusicFromTextResponse = {
  error?: string;
  music?: string;
};

export type GenerateAndExecuteCodeParams = {
  prompt: string;
  search_grounding?: boolean;
  status_update: string;
  task_id?: string;
...
export type GenerateAndExecuteCodeResponse = {
  error?: string;
  result?: string;
};
...
export const declarations: FunctionDeclaration[] = [
    ...
    "parametersJsonSchema": {
      ...
      "properties": {
        ...
        "aspect_ratio": {
          ...
          "description": "The aspect ratio for the generated images"
        },
        "file_name": {
          "type": "string",
          "description": "Optional name for the generated file (without extension). Use snake_case for naming. The system will automatically add the appropriate extension based on the file type."
        },
        "task_id": {
          "type": "string"
        },
    ...
    "responseJsonSchema": {
      ...
      "properties": {
        ...
        "images": {
          ...
          "items": {
            "type": "string",
            "description": "A generated image, specified as a file path"
          },
  ...
  {
    "name": "generate_text",
    "description": "An extremely versatile text generator, powered by Gemini. Use it for any tasks\nthat involve generation of text. Supports multimodal content input.",
    "parametersJsonSchema": {
      "$schema": "https://json-schema.org/draft/2020-12/schema",
      "type": "object",
      "properties": {
        "prompt": {
          "type": "string",
          "description": "Detailed prompt to use for text generation. The prompt may include references to files. For instance, if you have an existing file at \"/mnt/text3.md\", you can reference it as <file src=\"/mnt/text3.md\" /> in the prompt. If you do not use <file> tags, the text generator will not be able to access the file.\n\nThese references can point to files of any type, such as images, audio, videos, etc."
        },
        "model": {
          "type": "string",
          "enum": [
  ...
  },
  {
    ...
    "parametersJsonSchema": {
      ...
      "properties": {
        ...
        "images": {
          ...
          "items": {
            "type": "string",
            "description": "A reference input image, specified as a VS path"
          },
          "description": "A list of input reference images, specified as file paths. Use reference images only when you need to start with a particular image."
        },
        "aspect_ratio": {
          "default": "16:9",
          "type": "string",
    ...
    "responseJsonSchema": {
      ...
      "properties": {
        ...
        "video": {
          "type": "string",
          "description": "Generated video, specified as file path"
        }
      },
      "additionalProperties": false
    }
  },
  {
    ...
    "responseJsonSchema": {
      ...
      "properties": {
        ...
        "speech": {
          "type": "string",
          "description": "Generated speech as a file path"
        }
      },
      "additionalProperties": false
    }
  },
  {
    ...
    "responseJsonSchema": {
      ...
      "properties": {
        ...
        "music": {
          "type": "string",
          "description": "Generated music as a file path"
        }
      },
      "additionalProperties": false
    }
  },
  {
    ...
    "parametersJsonSchema": {
      ...
      "properties": {
        "prompt": {
          "type": "string",
          "description": "Detailed prompt for the code to generate. DO NOT write Python code as the prompt. Instead DO use the natural language. This will let the code generator within this tool make the best decisions on what code to write. Your job is not to write code, but to direct the code generator.\n\nThe prompt may include references to files as <file> tags. They will be correctly marshalled across the sandbox boundary."
        },
        "search_grounding": {
          "type": "boolean",
          "description": "Whether or not to use Google Search grounding. Grounding with Google Search\nconnects the code generation model to real-time web content and works with all available languages. This allows Gemini to power more complex use cases."
        },
        "status_update": {
          "type": "string",
          "description": "A status update to show in the UI that provides more detail on the reason why this function was called.\n  \n  For example, \"Creating random values\", \"Writing the memo\", \"Generating videos\", \"Making music\", etc."
    ...
    "responseJsonSchema": {
      ...
      "properties": {
        ...
        "result": {
          "type": "string",
          "description": "The result of code execution as text that may contain file path references"
        }
      },
      "additionalProperties": false
    }
