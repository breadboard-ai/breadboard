...
from opal_backend_shared.suspend import SuspendError, SuspendResult
...
from opal_backend_shared.function_definition import FunctionDefinition
from opal_backend_shared.loop import Loop, AgentRunArgs, LoopController
...
class TestLoopSuspend(unittest.TestCase):
    ...
    def test_loop_returns_suspend_result(self):
        ...
        from opal_backend_shared.function_definition import FunctionGroup
    ...
    def test_on_finish_not_called_on_suspend(self):
        ...
        from opal_backend_shared.function_definition import FunctionGroup
        from opal_backend_shared.loop import LoopHooks
