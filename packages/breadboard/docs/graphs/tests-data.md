...
%%{init: 'themeVariables': { 'fontFamily': 'Fira Code, monospace' }}%%
graph LR;
nodea["error <br> id='node-a'"] -- "text->description" --> nodec{{"output <br> id='node-c'"}}:::output
nodea["error <br> id='node-a'"] -- "$error->$error" --> nodeb{{"output <br> id='node-b'"}}:::output
nodeb{{"output <br> id='node-b'"}}:::output -- "$error->explanation" --> nodec{{"output <br> id='node-c'"}}:::output
classDef default stroke:#ffab40,fill:#fff2ccff,color:#000
classDef input stroke:#3c78d8,fill:#c9daf8ff,color:#000
classDef output stroke:#38761d,fill:#b6d7a8ff,color:#000
classDef passthrough stroke:#a64d79,fill:#ead1dcff,color:#000
...
## error-not-caught.json

```mermaid
%%{init: 'themeVariables': { 'fontFamily': 'Fira Code, monospace' }}%%
graph LR;
nodea["error <br> id='node-a'"] -- "text->description" --> nodec{{"output <br> id='node-c'"}}:::output
nodea["error <br> id='node-a'"] -- "text->text" --> nodeb["noop <br> id='node-b'"]
...
## exception-caught.json

```mermaid
%%{init: 'themeVariables': { 'fontFamily': 'Fira Code, monospace' }}%%
graph LR;
nodea["throw <br> id='node-a'"] -- "text->description" --> nodec{{"output <br> id='node-c'"}}:::output
nodea["throw <br> id='node-a'"] -- "$error->$error" --> nodeb{{"output <br> id='node-b'"}}:::output
nodeb{{"output <br> id='node-b'"}}:::output -- "$error->explanation" --> nodec{{"output <br> id='node-c'"}}:::output
classDef default stroke:#ffab40,fill:#fff2ccff,color:#000
classDef input stroke:#3c78d8,fill:#c9daf8ff,color:#000
classDef output stroke:#38761d,fill:#b6d7a8ff,color:#000
...
## exception-not-caught.json

```mermaid
%%{init: 'themeVariables': { 'fontFamily': 'Fira Code, monospace' }}%%
graph LR;
nodea["throw <br> id='node-a'"] -- "text->description" --> nodec{{"output <br> id='node-c'"}}:::output
nodea["throw <br> id='node-a'"] -- "text->text" --> nodeb["noop <br> id='node-b'"]
nodeb["noop <br> id='node-b'"] -- "text->context" --> nodec{{"output <br> id='node-c'"}}:::output
classDef default stroke:#ffab40,fill:#fff2ccff,color:#000
classDef input stroke:#3c78d8,fill:#c9daf8ff,color:#000
classDef output stroke:#38761d,fill:#b6d7a8ff,color:#000
...
%%{init: 'themeVariables': { 'fontFamily': 'Fira Code, monospace' }}%%
graph LR;
 -- "text->text" --> output1{{"output <br> id='output-1'"}}:::output
classDef default stroke:#ffab40,fill:#fff2ccff,color:#000
classDef input stroke:#3c78d8,fill:#c9daf8ff,color:#000
classDef output stroke:#38761d,fill:#b6d7a8ff,color:#000
classDef passthrough stroke:#a64d79,fill:#ead1dcff,color:#000
