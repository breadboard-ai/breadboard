...
const board = new Board({
  ...
  description:
    "An implementation of the [ReAct](https://react-lm.github.io/) AI pattern that relies on Breadboard [slots](https://github.com/breadboard-ai/breadboard/blob/main/packages/breadboard/docs/nodes.md#the-slot-node) to supply tools to ReAct. The slots are currently populated by two boards: `search-summarize` and `math`.",
  version: "0.0.1",
});
