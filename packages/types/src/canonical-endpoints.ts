...
// List of canonical endpoints used in the Opal guest application
...
export const GOOGLE_GENAI_API_PREFIX = "https://generativelanguage.googleapis.com/v1beta/models";
export const GOOGLE_DOCS_API_PREFIX = "https://docs.googleapis.com/v1/documents";
export const GOOGLE_SLIDES_API_PREFIX = "https://slides.googleapis.com/v1/presentations";
export const GOOGLE_SHEETS_API_PREFIX = "https://sheets.googleapis.com/v4/spreadsheets";
