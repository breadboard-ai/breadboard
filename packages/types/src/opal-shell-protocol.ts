...
import type { OpalBackendClient } from "./opal-backend-client.js";

export type { OpalBackendClient, OpalBackendRequestOptions } from "./opal-backend-client.js";
...
export declare interface OpalShellHostProtocol {
  ...
  getOpalBackendClient(): Promise<OpalBackendClient>;
