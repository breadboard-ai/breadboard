...
localMemory8["localMemory id='localMemory-8'"] -- "context->context" --> albert["promptTemplate id='albert'"]
textCompletion7["textCompletion id='textCompletion-7'"] -- "completion->Friedrich" --> localMemory8["localMemory id='localMemory-8'"]
textCompletion7["textCompletion id='textCompletion-7'"] -- "completion->text" --> output9{{"output id='output-9'"}}:::output
secrets2("secrets id='secrets-2'"):::secrets -- "PALM_KEY->PALM_KEY" --o textCompletion7["textCompletion id='textCompletion-7'"]
promptTemplate3["promptTemplate id='promptTemplate-3'"] -- "prompt->text" --> textCompletion7["textCompletion id='textCompletion-7'"]
localMemory1["localMemory id='localMemory-1'"] -- "context->context" --> albert["promptTemplate id='albert'"]
input10[/"input id='input-10'"/]:::input -- "text->topic" --> localMemory1["localMemory id='localMemory-1'"]
