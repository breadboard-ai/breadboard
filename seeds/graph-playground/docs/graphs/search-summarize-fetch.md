# search-summarize-fetch
  - Original: [`search-summarize-fetch.ts`](../../src/boards/search-summarize-fetch.ts)
  - Graph: [`search-summarize-fetch.json`](../../graphs/search-summarize-fetch.json)
...
secrets6("secrets id='secrets-6'"):::secrets -- "API_KEY->API_KEY" --> textCompletion1["textCompletion id='textCompletion-1'"]
secrets6("secrets id='secrets-6'"):::secrets -- "API_KEY->API_KEY" --> urlTemplate3["urlTemplate id='urlTemplate-3'"]
