...
secrets2("secrets <br> id='secrets-2'"):::secrets -- "PALM_KEY->PALM_KEY" --o reactcompletion["palm-generateText <br> id='react-completion'"]
...
promptTemplate5["promptTemplate <br> id='promptTemplate-5'"] -- "prompt->text" --> reactcompletion["palm-generateText <br> id='react-completion'"]
