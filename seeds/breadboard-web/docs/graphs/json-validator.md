...
validateJson1["validateJson <br> id='validateJson-1'"] -- "$error->json" --> prettifyError["jsonata <br> id='prettifyError'"]
prettifyError["jsonata <br> id='prettifyError'"] -- "result->error" --> outputFailure{{"output <br> id='outputFailure'"}}:::output
