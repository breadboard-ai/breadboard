...
locationandgenerator[/"input <br> id='location-and-generator'"/]:::input -- "model->$l-guideGenerator-model" --o lambda1["lambda <br> id='lambda-1'"]
...
lambda1_input1[/"input <br> id='input-1'"/]:::input -- "$l-guideGenerator-model->model" --o lambda1_guideGenerator["invoke <br> id='guideGenerator'"]
