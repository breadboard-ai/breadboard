...
graph TD;
secrets1("secrets <br> id='secrets-1'"):::secrets -- "PALM_KEY->PALM_KEY" --> travelItineraryGenerator["palm-generateText <br> id='travelItineraryGenerator'"]
...
lambda2_secrets3("secrets <br> id='secrets-3'"):::secrets -- "PALM_KEY->PALM_KEY" --o lambda2_guideGenerator["palm-generateText <br> id='guideGenerator'"]
lambda2_guideGenerator["palm-generateText <br> id='guideGenerator'"] -- "completion->guide" --> lambda2_output2{{"output <br> id='output-2'"}}:::output
lambda2_guideTemplate["promptTemplate <br> id='guideTemplate'"] -- "prompt->text" --> lambda2_guideGenerator["palm-generateText <br> id='guideGenerator'"]
...
travelItineraryGenerator["palm-generateText <br> id='travelItineraryGenerator'"] -- "completion->itinerary" --> splitItinerary["runJavascript <br> id='splitItinerary'"]
travelItinerary["promptTemplate <br> id='travelItinerary'"] -- "prompt->text" --> travelItineraryGenerator["palm-generateText <br> id='travelItineraryGenerator'"]
