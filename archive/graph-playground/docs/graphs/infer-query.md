...
graph TD;
questionGenerator["palm-generateText <br> id='questionGenerator'"] -- "completion->text" --> printResults{{"output <br> id='printResults'"}}:::output
secrets1("secrets <br> id='secrets-1'"):::secrets -- "PALM_KEY->PALM_KEY" --> questionGenerator["palm-generateText <br> id='questionGenerator'"]
inferringPrompt["promptTemplate <br> id='inferringPrompt'"] -- "prompt->text" --> questionGenerator["palm-generateText <br> id='questionGenerator'"]
