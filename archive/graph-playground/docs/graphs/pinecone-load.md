...
lambda2_lambda3_palmembedText4["palm-embedText <br> id='palm-embedText-4'"] -- "embedding->embedding" --> lambda2_lambda3_merge["append <br> id='merge'"]
lambda2_lambda3_secrets5("secrets <br> id='secrets-5'"):::secrets -- "PALM_KEY->PALM_KEY" --> lambda2_lambda3_palmembedText4["palm-embedText <br> id='palm-embedText-4'"]
lambda2_lambda3_jsonata3["jsonata <br> id='jsonata-3'"] -- "result->text" --> lambda2_lambda3_palmembedText4["palm-embedText <br> id='palm-embedText-4'"]
