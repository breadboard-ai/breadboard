...
lambda3_secrets3("secrets <br> id='secrets-3'"):::secrets -- "PALM_KEY->PALM_KEY" --o lambda3_palmgenerateText4["palm-generateText <br> id='palm-generateText-4'"]
lambda3_input1[/"input <br> id='input-1'"/]:::input -- "text->text" --> lambda3_palmgenerateText4["palm-generateText <br> id='palm-generateText-4'"]
lambda3_palmgenerateText4["palm-generateText <br> id='palm-generateText-4'"] -- "completion->json" --> lambda3_validateJson5["validateJson <br> id='validateJson-5'"]
...
lambda3_palmgenerateText4["palm-generateText <br> id='palm-generateText-4'"] -- "completion->completion" --> lambda3_validateJson5["validateJson <br> id='validateJson-5'"]
lambda3_palmgenerateText4["palm-generateText <br> id='palm-generateText-4'"] -- "completion->completion" --> lambda3_runJavascript6["runJavascript <br> id='runJavascript-6'"]
end
