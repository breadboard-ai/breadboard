...
palmgenerateText3["palm-generateText <br> id='palm-generateText-3'"] -- "completion->text" --> albertSays{{"output <br> id='albertSays'"}}:::output
...
palmgenerateText4["palm-generateText <br> id='palm-generateText-4'"] -- "completion->Friedrich" --> rememberFriedrich["append <br> id='rememberFriedrich'"]
palmgenerateText4["palm-generateText <br> id='palm-generateText-4'"] -- "completion->text" --> friedrichSays{{"output <br> id='friedrichSays'"}}:::output
...
promptTemplate2["promptTemplate <br> id='promptTemplate-2'"] -- "prompt->text" --> palmgenerateText4["palm-generateText <br> id='palm-generateText-4'"]
