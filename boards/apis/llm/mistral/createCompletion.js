...
1. Create an environment variable called MISTRAL_AI_API_KEY with your API key
2. npx breadboard run createChatCompletion.js --input-file=./tests/createChatCompletionRequest.json --kit=@google-labs/core-kit
*/
