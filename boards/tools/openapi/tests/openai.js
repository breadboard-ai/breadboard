...
// To run this: npx breadboard run boards/tools/openapi/tests/openai.js --kit @google-labs/core-kit -i "{\"url\":\"https://raw.githubusercontent.com/breadboard-ai/breadboard/c371c2cd5aca33673e30fc647c920228752e41ee/recipes/tools/openapi/tests/specs/openai.json\"}"
...
export default await board(() => {
  ...
  return core.invoke().in({
    ...
    ...core.secrets({ keys: ["OPENAI_API_KEY"] }),
  });
}).serialize(metaData);
